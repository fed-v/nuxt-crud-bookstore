...
async function resolveVueI18nAlias(pkgModulesDir2, nuxt, pkgMgr) {
  ...
  const modulePath = nuxt.options.dev || nuxt.options._prepare ? `${VUE_I18N_PKG}/dist/vue-i18n.mjs` : `${VUE_I18N_PKG}/dist/vue-i18n.runtime.mjs`;
  const targets = [
    // for Nuxt layer
...
function getFeatureFlags(jit = true, compositionOnly = true) {
  return {
...
const module = defineNuxtModule({
  ...
  async setup(i18nOptions, nuxt) {
    ...
    if (options.bundle.compositionOnly && options.types === "legacy") {
      throw new Error(
        formatMessage(
          `'i18n.bundle.compositionOnly' option and 'i18n.types' option is conflicting: i18n.bundle.compositionOnly: ${options.bundle.compositionOnly}, i18n.types: ${JSON.stringify(options.types)}`
        )
      );
    }
