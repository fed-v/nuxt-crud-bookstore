...
export declare function loadAndSetLocale<Context extends NuxtApp = NuxtApp>(newLocale: string, context: Context, i18n: I18n, { useCookie, skipSettingLocaleOnNavigate, differentDomains, initial, lazy }?: Pick<DetectBrowserLanguageOptions, 'useCookie'> & Pick<NuxtI18nOptions<Context>, 'lazy' | 'skipSettingLocaleOnNavigate' | 'differentDomains'> & {
    initial?: boolean;
}): Promise<[boolean, string]>;
type LocaleLoader = () => Locale;
export declare function detectLocale<Context extends NuxtApp = NuxtApp>(route: string | Route | RouteLocationNormalized | RouteLocationNormalizedLoaded, context: any, routeLocaleGetter: ReturnType<typeof createLocaleFromRouteGetter>, nuxtI18nOptions: DeepRequired<NuxtI18nOptions<Context>>, initialLocaleLoader: Locale | LocaleLoader, detectLocaleContext: DetectLocaleContext, normalizedLocales: LocaleObject[], localeCodes?: string[]): any;
export declare function detectRedirect<Context extends NuxtApp = NuxtApp>({ route, context, targetLocale, routeLocaleGetter, nuxtI18nOptions, calledWithRouting }: {
    route: {
